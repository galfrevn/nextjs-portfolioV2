...
const images = [
  {
    src: "/study/google/a.jpg",
  },
  {
    src: "/study/google/b.jpg",
  },
  {
    src: "/study/google/c.jpg",
  },
  {
    src: "/study/google/d.jpg",
  },
  {
    src: "/study/google/e.jpg",
  },
  {
    src: "/study/google/f.jpg",
  },
  {
    src: "/study/google/g.jpg",
  },
];
...
function ProjectPage() {
  return (
    <>
      <Head>
        <title> Case study (Google Search) | Galfré Valentín Portfolio </title>
      ...
      <div className="md:max-w-6xl md:mx-auto mt-36 px-6 pt-6">
        ...
        <h1 className="text-[#111010] text-[20px] md:text-4xl font-bold leading-[1.45] ">
          React Responsive Google Search Clone
        </h1>
        ...
        <div className="flex space-x-4 items-center ">
          <Link
            href={"https://github.com/galfrevn/nextjs-google-clone"}
            passHref
          >
            <a
              target="_blank"
          ...
          <Link href={"https://vnsearch.netlify.app"} passHref>
            <a
              target="_blank"
              rel="noreferrer"
              className="text-[12px] md:text-[16px] md:py-4 md:px-8 bg-[#81a7f8] font-semibold transitiona-all duration-300 text-white py-3 px-6 "
            >
              Live demo
            </a>
          </Link>
