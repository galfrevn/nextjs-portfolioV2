...
function ProjectPage() {
  return (
    <>
      <Head>
        <title> Case study (Mercadolibre) | Galfré Valentín Portfolio </title>
        <meta
          name="description"
          content={`Galfré Valentín portfolio | Mercadolibre`}
        />
        ...
        <div className="flex space-x-4 items-center ">
          ...
          <Link href={"https://vnmeli.netlify.app"} passHref>
            <a
              target="_blank"
              rel="noreferrer"
              className="text-[12px] md:text-[16px] md:py-4 md:px-8 bg-[#e9b935] font-semibold transitiona-all duration-300 text-white py-3 px-6 "
            >
              Live demo
            </a>
          </Link>
